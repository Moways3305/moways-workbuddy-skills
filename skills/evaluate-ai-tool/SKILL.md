...
title: 评测 AI 工具
agent_created: true
tags: [ai-tool-factory, evaluation, release-checklist, bovey]
trigger:
  - 评测 Skill 或 Plugin
  - 检查误触发
  - 发布前验收
...
```powershell
python ../bovey-ai-tool-factory/scripts/validate_product.py <path> --run-official --markdown-out <report.md>
```
...
```powershell
python ../bovey-ai-tool-factory/scripts/build_package.py <plugin-root> --output <release-dir>
```
